const CACHE="brighton-weekend-v60-auth-groups-share";
...
async function transformIndex(response){
 ...
 // Magic-link callback: explicitly exchange a PKCE code when Supabase returns one, then
 // let getSession/onAuthStateChange bootstrap the authenticated app rather than showing login again.
 ...
 // Never expose the raw Supabase rate-limit wording to users.
 ...
 // First sign-in/group onboarding: Party On is only allowed once at least one group exists.
