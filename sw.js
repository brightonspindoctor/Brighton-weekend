const CACHE="brighton-weekend-v79-avatar-assets";
...
async function transformIndex(response){
 ...
 text=text.replace(/'raccoon',/g,'').replace(/,/g,'').replace(//g,'');
 ...
 text=text.replace(/'winged-lion':'Winged Lion'\}/,"'winged-lion':'Winged Lion','brown-bear':'Brown Bear','red-panda-bear':'Red Panda','giant-panda-bear':'Giant Panda',}");
