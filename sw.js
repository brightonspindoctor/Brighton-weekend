...
async function transformIndex(response){
 ...
 // Shareable group invites. Public groups can be joined directly from the invite link;
 // private groups still require their 3-digit PIN.
 ...
 // open the join form with the group name already filled and ask only for the PIN.
 ...
 // Preserve the group-screen usability fixes and add compact invite controls.
