const CACHE="brighton-weekend-v56-bears-auth";
...
async function transformIndex(response){
 ...
 // Add the three bear avatars to the real picker data served to the app.
 ...
 // Bear artwork is SVG; the rest of the existing avatar artwork remains PNG.
